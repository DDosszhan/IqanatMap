...
export function BuildingPlaceholderPage({ building, lang }: { building: Building; lang: Lang }) {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#172119] text-white">
...
<Image
        ...
        <div className="relative z-10 max-w-4xl">
          <Link
            className="inline-flex items-center gap-2 text-sm font-semibold text-[#dfe8c7] transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c7d8a7] focus-visible:ring-offset-2 focus-visible:ring-offset-[#172119]"
            href={languagePath(lang, "/map")}
          >
            <ArrowLeft className="h-4 w-4" />
            {t.backToMap}
          </Link>
          <div className="mt-10 flex items-center gap-3 text-[#dfe8c7]">
